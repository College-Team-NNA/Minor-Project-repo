...
class _ChatState extends State<Chat> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(padding: const EdgeInsets.only(left: 30.0, right: 30.0, top: 10,bottom: 20),
        child: Row(
          children: [
            Expanded(flex: 3,
              child: Container(
                    ...
                    SizedBox(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(color: Color(0xFFACACAC),fontSize: 13,),
                          ...
                          Expanded(
                              child: TextField(
                                decoration: InputDecoration(
                                  ...
                                  hintStyle: TextStyle(color: Color(0xFF3E3E3E),fontSize: 13,),
                                ),
                              )
                          ),
                          Spacer(),
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ClipRRect(
              borderRadius: BorderRadius.circular(8.0), // You can adjust the roundness here
              child:profileImage,
            ),
            SizedBox(width: 10),

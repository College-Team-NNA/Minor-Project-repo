                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            RichText(
                              ...
                              text: TextSpan(
                                style: DefaultTextStyle.of(context)
                                    .style
                                    .copyWith(color: const Color(0xFF9489E9)), // Default text color
                                children: [
                                  TextSpan(
                                    text: 'Welcome to\nthe new ',
                        ...
                        const Text("Tip: Search using tags for better results."),
                      ],
                    ),
                  ),
                  LayoutBuilder(builder: (context, constraints) {
                    return CustomPaint(
                      size: Size(constraints.maxWidth * 0.7, 7), // 70% of screen width
                              ...
                              children: [
                                OutlinedButton(
                                  ...
                                  style: OutlinedButton.styleFrom(
                                    padding: EdgeInsets.symmetric(horizontal: 2.0, vertical: 0.0), // Reduced padding
                              ...
                              return Container(
                                ...
                                child: Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: FutureBuilder(
                                        future:
                                        (index % 2 == 0) ? link("1.png") : link("2.png"),
  ...
  Widget build(BuildContext context) {
    return OutlinedButton(
      style: OutlinedButton.styleFrom(
        ...
        backgroundColor: isSelected ? const Color(0xFF9489E9) : Colors.transparent,
        shape: RoundedRectangleBorder(
      ...
      onPressed: () {},
      child: Text(label,style: GoogleFonts.montserrat(fontWeight: FontWeight.w500, fontSize: Theme_req.stxt_size)
      ),
    );
  }
}
class TaperedDividerPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (double i = 0; i < size.width; i++) {
      double thickness = 6.0 * (1 - ((i - size.width / 2).abs() / (size.width / 2))); // Adjust thickness
